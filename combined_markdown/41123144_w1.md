---
Title: 2024 Spring 課程 第一週
Date: 2024-02-24 13:20
Category: w1
Tags: 網誌編寫
Slug: 41123144_w1
Author: 41123144
...
# 建立個人課程倉儲
登入 github.com, 連結到 https://github.com/mdecycu/cmsimde_site, 將此倉儲作為 Template, 建立課程 cd2024 的倉儲, 並將 main 分支設為網頁根目錄.

# 將倉儲 import 至 Replit
從 replit 頭像的 Account, 找到 Connected Services 點選 Connect 後, 讓 Github 授權 Replit, 等待 Replit 中的倉儲改版, 改版完就有權限推回 Github.

# 如何 import 倉儲至 Replit 進行改版
import 完會出現 Webview , 初始登入密碼打 admin 就可進入動態網頁進行編輯, 編輯完點選 Convert 轉為靜態 , 到 Replit 的 Git 中輸入新增的內容後 Push , 等待一下就可以在靜態看到新]增的內容.
...
# Odoo PLM
建立一個產品網頁 , 依分配的工作完成後 回傳至 odoo PLM 裡.
